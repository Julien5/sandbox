...
impl Tile {
    ...
    pub fn _print_all(&self) {
        let print_lookup: [u8; 11] = [
            b' ', b'1', b'2', b'3', b'4', b'5', b'6', b'7', b'8', b'B', b' ',
        ];
        debug_assert!(!self.grid.is_empty());
    ...
    fn increment_neighbors(&mut self, pos: usize) {
