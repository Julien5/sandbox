...
echo write_flash
python $IDF_PATH/components/esptool_py/esptool/esptool.py --chip esp8266 -p $DEVICE -b 460800 write_flash --flash_mode dio --flash_freq 40m --flash_size 2MB 0x8000 /tmp/builds/esp8266/core/partition_table/partition-table.bin 0x0 /tmp/builds/esp8266/core/bootloader/bootloader.bin 0x10000 "$BINFILE"
