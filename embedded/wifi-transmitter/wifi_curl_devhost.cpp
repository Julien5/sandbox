...
int
exe(const std::string& method, const char* req, wifi::callback* cb, const uint8_t* data = nullptr, const int Ldata = 0)
{
...
int
wifi::wifi_curl::get(const char* req, callback* r)
{
  return exe("GET", req, r);
}

int
wifi::wifi_curl::post(const char* req, const uint8_t* data, const uint16_t Ldata, callback* r)
{
